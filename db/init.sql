...
INSERT INTO items (item_id, item_name, item_description, category_id) VALUES
(1, 'Смартфон Galaxy S21', 'Премиальный смартфон с высокими техническими характеристиками', 2),
(2, 'Планшет iPad Air', 'Легкий и мощный планшет от Apple', 3),
(3, 'Ноутбук ThinkPad X1 Carbon', 'Легкий и производительный ноутбук для бизнеса', 6),
(4, 'Холодильник LG', 'Большой двухдверный холодильник с технологией NoFrost', 5),
(5, 'Графическая карта NVIDIA RTX 3080', 'Мощная графическая карта для игр и тяжелых задач', 4),
(6, 'Наушники Sony WH-1000XM4', 'Беспроводные наушники с системой шумоподавления', 7),
(7, 'HDMI кабель 2.0', 'Высокоскоростной кабель для передачи видео в высоком разрешении', 8),
(8, 'Беспроводная зарядка Anker', 'Зарядное устройство для смартфонов с поддержкой беспроводной зарядки', 7);
...
INSERT INTO shops (shop_id, shop_name, shop_description, shop_url) VALUES
(1, 'Электроника24', 'Онлайн магазин электроники', 'https://www.electronics24.com'),
(2, 'ГаджетМаг', 'Широкий ассортимент гаджетов', 'https://www.gadgetmag.com'),
(3, 'ТехникаМир', 'Специализированный магазин бытовой техники', 'https://www.techworld.com'),
(4, 'НоутбукШоп', 'Магазин ноутбуков и аксессуаров', 'https://www.laptopshop.com');
...
INSERT INTO item_shop_associations (shop_id, item_id, item_url) VALUES
(1, 1, 'https://www.electronics24.com/smartphone-galaxy-s21'),
